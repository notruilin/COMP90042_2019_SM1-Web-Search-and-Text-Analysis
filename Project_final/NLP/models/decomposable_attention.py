...
Retrieved from https://github.com/allenai/allennlp-as-a-library-example/blob/master/my_library/models/academic_paper_classifier.py
...
@Model.register("decomposable_attention_model_reference")
class DecomposableAttention(Model):
    ...
    def decode(self, output_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        class_probabilities = F.softmax(output_dict['label_logits'], dim=-1)
